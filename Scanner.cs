...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 48; i <= 57; ++i) start[i] = 37;
		start[34] = 4; 
		start[39] = 6; 
		start[123] = 9; 
		start[125] = 10; 
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "float": t.kind = 40; break;
			case "char": t.kind = 41; break;
			case "string": t.kind = 42; break;
			case "main": t.kind = 43; break;
			case "void": t.kind = 44; break;
			case "return": t.kind = 45; break;
			case "input": t.kind = 46; break;
			case "print": t.kind = 47; break;
			case "if": t.kind = 48; break;
			case "else": t.kind = 49; break;
			case "while": t.kind = 50; break;
			case "for": t.kind = 51; break;
